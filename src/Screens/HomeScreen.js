import { StyleSheet, Text, View, StatusBar,SafeAreaView, Dimensions, FlatList } from 'react-native'
...
const HomeScreen = ({navigation}) => {
    ...
    return (
        <View style={styles.container}>
            ...
            />
            <SafeAreaView horizontal={false} showsVerticalScrollIndicator={false} style={{ flex:1, width:'100%', paddingTop:10,}}>
                <FlatList
                  horizontal={false} 
