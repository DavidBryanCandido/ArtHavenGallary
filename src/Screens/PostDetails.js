...
{   
    ...
    return (
        <ScrollView contentContainerStyle={{ ...styles.container }}>
            ...
            <View>
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', minWidth: 300, maxWidth:'90%', marginHorizontal: 16 }}>
                    ...
                    {showAllTags ? (
                    <TouchableOpacity onPress={() => setShowAllTags(false)} style={{...styles.showMore, }}>
                        <Text  style={{ ...styles.textshow }}>Show less</Text>
                    </TouchableOpacity>
                    ) : (
